...
(function (root, factory) {
    ...
    var SuperGif = function ( opts ) {
        ...
        var player = (function () {
            ...
            var stepBackFrame = function (amount) { // XXX: Name is confusing.
                i = i - amount;
                putFrame();
            };
            ...
            var step = (function () {
                ...
                var doStep = function () {
                    ...
                    if (nextFrameNo === 0) {
                        delay += loopDelay;
                        currentTimer = setTimeout(completeLoop, delay);
                    } else {
                        currentTimer = setTimeout(doStep, delay);
                    }
                };

                return function () {
                    if (!stepping) currentTimer = setTimeout(doStep, 0);
                };
            }());

            var stepBack = (function () {

                var completeBackLoop = function () {
                    stepping = false;
                    playing = false;
                };
                ...
                var doStep = function () {
                    ...
                    var nextFrameNo = getBeforeFrameNo();
                    if (nextFrameNo === 0) {
                        delay += loopDelay;
                        currentTimer = setTimeout(completeBackLoop, delay);
                    } else {
                        currentTimer = setTimeout(doStep, delay);
                    }
                };
